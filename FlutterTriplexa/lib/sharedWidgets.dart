      ...
      child: Row(
        ...
        children:[
          for (int i = 0; i < icons.length; i++)
            GestureDetector(
              onTap: () => onTap(i),                      //tell the page with page is taped
              child:AnimatedContainer( duration: const Duration(milliseconds: 200), //smooth
                padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 8),
                decoration: BoxDecoration(                //highlighting the clicked icon
